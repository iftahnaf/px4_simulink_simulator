...
plant.mechanical.c_t = 5.947e-5; % thrust constant
plant.mechanical.c_q = 7.9217e-7; % drag constant
plant.mechanical.d = 0.25; % quad arm length
plant.mechanical.i_xx = 0.0115118; % i_xx on the diagonal inertial matrix
plant.mechanical.i_yy = 0.0365651; % i_yy on the diagonal inertial matrix 
plant.mechanical.i_zz = 0.0290742; % i_zz on the diagonal inertial matrix
plant.mechanical.j_l = plant.motor.j_l;
plant.mechanical.m = 1.37; % [kg] quadrotor mass
